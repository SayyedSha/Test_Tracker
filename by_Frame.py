    ...
    while True:
        ...
        try:
            for frame in frames:
                    ...
                    locator_q.put((frame,face_locations))
            ...
            for i, (frame) in enumerate(frames):
                ...
                for r in results:
                    ...
                    for box in boxes:
                        ...
                        ret=DeepFace.analyze(face_region, actions=["emotion", "age", "gender"],enforce_detection=False)
                        # print(image_path)


                        # processed_images.add(str(face_region))
                        ...
                        for person in persons:
                            collection_2.insert_one({"Person":person,"Age": age, "Dominant Gender": dominant_gender, "Dominant Emotion": dominant_emotion,"time":time.asctime()})
